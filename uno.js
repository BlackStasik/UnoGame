...
function getImages(card){
        ...
        switch (card.split(" ")[1]){
            case "r": images += "red/"; break;
            case "b": images += "blue/"; break;
            case "g": images += "green/"; break;
            case "y": images += "yellow/"; break;
        }

        switch (card.split(" ")[0]){
            case "0": images += "zero.png"; break;
            case "1": images += "one.png"; break;
            case "2": images += "two.png"; break;
            case "3": images += "three.png"; break;
            case "4": images += "four.png"; break;
            case "5": images += "five.png"; break;
            case "6": images += "six.png"; break;
            case "7": images += "seven.png"; break;
            case "8": images += "eight.png"; break;
            case "9": images += "nine.png"; break;
            case "+2": images += "add-two.png"; break;
            case "!": images += "stop.png"; break;
            case "<>": images += "reverse.png"; break;
            case "_": images += "exchange.png"; break;
            case "+4": images += "exchange-one.png"; break;
        }

        if(card.split(" ")[1] == "a" || card.split(" ")[0] == "+4" || card.split(" ")[0] == "_"){
            switch (card.split(" ")[1]){
                case "_": images = "resource/exchange.png"; break;
                case "+4": images = "resource/exchange-one.png"; break;
            }
        }
        return images;
}
...
function moveByComputer(){
	...
	if(c != ""){
		...
		if(!isWin()){
			...
			switch(c.split(" ")[0]){
				case "<>": moveByComputer(); break;
				case "!": moveByComputer(); break;
				case "+2": oneMoreCard(gamerCards); oneMoreCard(gamerCards); 
				moveByComputer(); break;
				case "+4": oneMoreCard(gamerCards); oneMoreCard(gamerCards);
				oneMoreCard(gamerCards); oneMoreCard(gamerCards); moveByComputer(); break;
				default: break;
			}
			updateDesk();
		}else{
...
function setRed(){
	if(isColorChange){
		...
		switch(currentCard.split(" ")[0]){
			case "<>": break;
			case "!": break;
			case "+2": oneMoreCard(computerCards); oneMoreCard(computerCards);break;
			case "+4": oneMoreCard(computerCards); oneMoreCard(computerCards);oneMoreCard(computerCards); oneMoreCard(computerCards);break;
			default: moveByComputer();
		}
		updateDesk();
	}
}
...
function setYellow(){
	if(isColorChange){
		...
		switch(currentCard.split(" ")[0]){
			...
			case "!": break;
			case "+2": oneMoreCard(computerCards); oneMoreCard(computerCards);break;
			case "+4": oneMoreCard(computerCards); oneMoreCard(computerCards);oneMoreCard(computerCards);
			oneMoreCard(computerCards);break;
		}
		updateDesk();
	}
}
		...
		if (isCorrectCard(card)) {
			...
			if (isWin()) {
				...
				if(currentCard.split(" ")[1] != "a"){
					...
					case "!": break;
					case "+2": oneMoreCard(computerCards); oneMoreCard(computerCards);break;
					case "+4": oneMoreCard(computerCards); oneMoreCard(computerCards);
					oneMoreCard(computerCards); oneMoreCard(computerCards);break;
					default:  moveByComputer();
					}
				updateDesk();
				}
